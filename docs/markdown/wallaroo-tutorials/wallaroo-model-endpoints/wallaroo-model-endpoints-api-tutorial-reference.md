...
```
    ...
    {'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJDYkFqN19QY0xCWTFkWmJiUDZ6Q3BsbkNBYTd6US0tRHlyNy0yLXlQb25nIn0..Vs6fFdEIxULUYVkMH5kwSWHJGF5TNxOEighlfQ33j6JdntcMhi2oRaprDMUL4C3YtqzIJUaR8vIwhNNzHiP6tbJ7Hei6OxGHUR6BwT7dqGY_Hqy2H_1hpHab8B6axCcguHfDNTggDvJXcWvQPAyXA_19uI_ecKZSEJVyrbKJxiBDeza5oMSQwJzg76Hk9JeAoGSQZZcm3ImPg9oXnYK0g1w8kCnWimNHIcOozmtjI9fTfSij3tdI1EENVjGhak6NcMQ9IZwws2cptsPta_D__5Y_ZzzMTbWNT7SZty-Fu7H7fI_-s7nAN8Q3p1v8AHluAxcUA8HUGHadHvuWor4FMQ'}
...
```
    ...
    {'insert_models': {'returning': [{'models': [{'id': 72}]}]}}
...
```
    ...
    {'id': 72,
     ...
     'workspace_id': 44,
     'name': 'wngoccfraud',
     'updated_at': '2023-05-19T18:19:52.620044+00:00',
     'created_at': '2023-05-19T18:19:52.620044+00:00',
     'model_config': None}
...
```
    ...
    [{'sha': 'bc85ce596945f876256f41515c7501c399fd97ebcb9ab3dd41bf03f8937b4507',
      'models_pk_id': 72,
      'model_version': 'bebf80df-9a4e-4319-b623-64602777636f',
      'owner_id': '""',
      'model_id': 'wngoccfraud',
      'id': 72,
      'file_name': 'wngoccfraud',
      'image_path': None,
      'status': 'ready'}]
...
```
    ...
    'bebf80df-9a4e-4319-b623-64602777636f'
...
```
    ...
    {'status': 'Running',
     'details': [],
     'engines': [{'ip': '10.244.1.87',
       'name': 'engine-744f8fc96d-d4jtj',
       'status': 'Running',
       'reason': None,
       'details': [],
       'pipeline_statuses': {'pipelines': [{'id': 'wngoapiinferenceexamplepipeline',
          'status': 'Running'}]},
       'model_statuses': {'models': [{'name': 'wngoccfraud',
          'version': 'bebf80df-9a4e-4319-b623-64602777636f',
          'sha': 'bc85ce596945f876256f41515c7501c399fd97ebcb9ab3dd41bf03f8937b4507',
          'status': 'Running'}]}}],
     'engine_lbs': [{'ip': '10.244.4.221',
       'name': 'engine-lb-584f54c899-qn7m2',
       'status': 'Running',
       'reason': None,
       'details': []}],
     'sidekicks': []}
...
```
    ...
    'https://doc-test.api.wallarooexample.ai/v1/api/pipelines/infer/wngoapiinferenceexamplepipeline-73/wngoapiinferenceexamplepipeline'
