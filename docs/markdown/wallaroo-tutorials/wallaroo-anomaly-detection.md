...
![png](/images/wallaroo-tutorials/wallaroo-anomaly-detection_files/wallaroo-anomaly-detection_17_0.png)
...
Pipeline logs can be displayed through the pipeline `logs()` method.  The parameter `valid=False` will show any validations that were flagged as `False` - in this case, houses that were above 100 million in value.
