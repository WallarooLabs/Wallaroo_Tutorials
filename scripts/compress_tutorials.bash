...
tutorials=(
    ...
    [pipeline-multiple-replicas-forecast-tutorial]="wallaroo-model-deploy-and-serve/pipeline-multiple-replicas-forecast-tutorial"
    ...
    [pipeline-log-tutorial]="wallaroo-features/pipeline-log-tutorial"
    ...
    [notebooks-in-prod]="wallaroo-model-deploy-and-serve/notebooks-in-prod"
    ...
    [aloha-async-infer]="wallaroo-model-deploy-and-serve/aloha-async-infer"
    )
