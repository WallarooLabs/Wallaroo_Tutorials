...
tutorials=(
    ...
    [wallaroo-inference-server-cv-unet]="wallaroo-inference-server-tutorials/wallaroo-inference-server-cv-unet"
    ...
    [computer-vision-yolov8]="wallaroo-model-cookbooks/computer-vision-yolov8"
    [demand_curve]="wallaroo-model-cookbooks/demand_curve"
    [hf-clip-vit-base]="wallaroo-model-cookbooks/hf-clip-vit-base"
    ...
    [wallaroo-model-upload-deploy-byop-cv-tutorial]="wallaroo-model-cookbooks/wallaroo-model-upload-deploy-byop-cv-tutorial"
